...
public:
    ...
    SigmaDevice(ros::NodeHandle n, const std::string name_space,int i);
    ...
    void HandleWrenchAlways(double p);
...
private:
    ...
    geometry_msgs::Vector3Stamped force_msg;
    geometry_msgs::Vector3Stamped orientation_msg;
