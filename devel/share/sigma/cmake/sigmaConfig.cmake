...
if("TRUE" STREQUAL "TRUE")
  set(sigma_SOURCE_PREFIX /home/chy/sigma_iiwa_simulation/ur_sigma/src/sigma7)
  set(sigma_DEVEL_PREFIX /home/chy/sigma_iiwa_simulation/ur_sigma/devel)
  set(sigma_INSTALL_PREFIX "")
  set(sigma_PREFIX ${sigma_DEVEL_PREFIX})
else()
  set(sigma_SOURCE_PREFIX "")
  set(sigma_DEVEL_PREFIX "")
  set(sigma_INSTALL_PREFIX /home/chy/sigma_iiwa_simulation/ur_sigma/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'sigma' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'sigma' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/chy/sigma_iiwa_simulation/ur_sigma/src/sigma7/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT sigma_NUM_DUMMY_TARGETS)
      set(sigma_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::sigma::wrapped-linker-option${sigma_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR sigma_NUM_DUMMY_TARGETS "${sigma_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::sigma::wrapped-linker-option${sigma_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND sigma_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${sigma_dep}_FOUND)
      find_package(${sigma_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${sigma_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  ...
  _list_append_deduplicate(sigma_EXPORTED_TARGETS ${${sigma_dep}_EXPORTED_TARGETS})
endforeach()
