...
"""autogenerated by genpy from dmp/GoalToPathRequest.msg. Do not edit."""
import codecs
import sys
...
class GoalToPathRequest(genpy.Message):
  _md5sum = "47f8665a74074523c873649f357d3ba7"
  _type = "dmp/GoalToPathRequest"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """float64[] Start

int32 GoalIndex
"""
  __slots__ = ['Start','GoalIndex']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GoalToPathRequest, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.Start is None:
        self.Start = []
      if self.GoalIndex is None:
        self.GoalIndex = 0
    else:
      self.Start = []
      self.GoalIndex = 0
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.GoalIndex,) = _get_struct_i().unpack(str[start:end])
      return self
...
def _get_struct_i():
    ...
    return _struct_i
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from dmp/GoalToPathResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class GoalToPathResponse(genpy.Message):
  _md5sum = "24fae27c1f7b7e0732c341610d3780f7"
  _type = "dmp/GoalToPathResponse"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """
nav_msgs/Path Path
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GoalToPathResponse, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
...
def _get_struct_4d():
    ...
    return _struct_4d
class GoalToPath(object):
  _type          = 'dmp/GoalToPath'
  _md5sum = '61b7759cacf0fb0b224df3e235dda576'
  _request_class  = GoalToPathRequest
  _response_class = GoalToPathResponse
