...
"""autogenerated by genpy from dmp/DMPPointStamp.msg. Do not edit."""
import codecs
import sys
...
class DMPPointStamp(genpy.Message):
  _md5sum = "db08163e791135724278324162c51a67"
  _type = "dmp/DMPPointStamp"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """std_msgs/Header head
float64 positions
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(DMPPointStamp, self).__init__(*args, **kwds)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.positions,) = _get_struct_d().unpack(str[start:end])
      return self
